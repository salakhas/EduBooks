...
export const BrowseDiv = () => {
    return (
        <div className="browseDiv">
            <div className="discBrowseDiv">
                <p className="mt-2 ml-3" style={{fontSize: "18px"}}>Browse books..</p>
                <button className="btn ml-2"  style={{backgroundColor: "#12D7B9",color: "white",boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px"}}  type="submit">View More</button>
            </div>
            <div className="browseDisplay">
                {books.map((el)=>{
                    return (
                        <div key={nanoid()} className="indDivBook">
                            <div className="imgDiv">
                                <img src={el.thumbnail} alt="book" className="imgDivPic"/>
                            </div>
                            <div>
                                <h5>{el.title}</h5><br/>
                                <p>{el.author}</p>
                                <span style={{color: "#6F7275"}}><small>{el.reads} reads</small>&nbsp;&nbsp;&nbsp;<small>{el.rating}/5 rating</small></span>
                            </div>
                        </div>
                    )
                })}
